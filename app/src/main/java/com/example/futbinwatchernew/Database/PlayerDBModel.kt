...
data class PlayerDBModel(@PrimaryKey var id:Int, var name:String, var imageURL:String,
    ...
    constructor(data:SearchPlayerResponse): this(data.id, data.playerName, data.playerImage,
        data.playerRating, -1, null,false,false )

    constructor():this(-1,"","",-1,-1,null,false,false)
